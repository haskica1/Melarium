...
namespace Melarium.Entity.Migrations
{
    ...
    [Migration("20260830112029_AddOrganizationLogo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.AnnouncementRead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("AcceptedOrganizationId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("InviterOrganizationId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AcceptedOrganizationId");

                    b.HasIndex("EmailCanonical", "CreatedAt");

                    b.HasIndex("InviterOrganizationId", "RewardGrantedAt");

                    b.HasIndex("InviterUserId", "CreatedAt");
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.TreatmentRound", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TreatmentRounds", (string)null);
                });
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.AnnouncementRead", b =>
                {
                    b.HasOne("Melarium.Domain.Entities.Announcement", "Announcement")
                        .WithMany("Reads")
            ...
            modelBuilder.Entity("Melarium.Domain.Entities.Invitation", b =>
                {
                    b.HasOne("Melarium.Domain.Entities.User", "AcceptedByUser")
                        .WithMany()
                        .HasForeignKey("AcceptedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Melarium.Domain.Entities.Organization", "AcceptedOrganization")
                        .WithMany()
                        .HasForeignKey("AcceptedOrganizationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Melarium.Domain.Entities.Organization", "InviterOrganization")
                        .WithMany()
                        .HasForeignKey("InviterOrganizationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Melarium.Domain.Entities.User", "Inviter")
                        .WithMany()
                    ...
                    b.Navigation("AcceptedOrganization");

                    b.Navigation("Inviter");

                    b.Navigation("InviterOrganization");
                });
